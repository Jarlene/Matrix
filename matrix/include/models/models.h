...
namespace matrix {
     ...
     * @return
     */
    Symbol MnistTestFullyConnected(const Symbol &input, int hideNum, int classNum) {
        ...
        auto y2 = Symbol("fullConnected")
                .SetInput("concat1", concat1)
                .SetParam("hide_num", hideNum/2)
                .SetParam("with_bias", true)
                .Build("y2");

        auto concat2 = Symbol("concat")
                .SetInput("y1", y1)
                .SetInput("y2", y2)
                .Build("concat2");
    ...
    Symbol MnistTestConv(const Symbol &input, int hideNum, int classNum) {
        auto conv1 = Symbol("convolution")
                .SetInput("data", input)
                .SetParam("filter", ShapeN(5, 5))
                .SetParam("with_bias", true)
